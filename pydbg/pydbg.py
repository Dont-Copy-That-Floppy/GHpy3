...
class pydbg:
    ...
    def __init__ (self, ff=True, cs=False):
        ...
        try:
            ...
            self.system_break = self.func_resolve("ntdll", "DbgBreakPoint")
    ...
    def debug_event_iteration (self):
        ...
        if kernel32.WaitForDebugEvent(byref(dbg), 100):
            ...
            # an exception was caught.
                ...
                self._log("debug_event_loop() exception: %016x" % ec)
                ...
                # unhandled exception.
                    ...
                    self._log("TID:%04x caused an unhandled exception (%08x) at %016x" % (self.dbg.dwThreadId, ec, self.exception_address))
    ...
    def exception_handler_breakpoint (self):
        ...
        # breakpoints we did set.
            ...
            self._log("restoring original byte at %016x" % self.exception_address)
    ...
    def get_debug_privileges (self):
        ...
        # print("Debug Privilege Variables...")
        # print("Handle: %s" % h_token)
        # print(ctypes.addressof(h_token))
        # print(byref(h_token))
        # print("LUID: %s" % luid)
        # print("Token State: %s" % token_state)
